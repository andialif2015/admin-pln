        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="layout-default.html">Daftar Data</a></li>
                  <li><a class="nav-link" href="layout-transparent.html">Sortir Data</a></li>
                  <li><a class="nav-link" href="layout-top-navigation.html">Upload File</a></li>
                </ul>
              </li>
              <li class="active"><a class="nav-link" href="blank.html"><i class="far fa-square"></i> <span>Upload File</span></a></li>
