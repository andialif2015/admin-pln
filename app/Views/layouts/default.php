          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="<?= base_url('user/show') ?>">Daftar Data</a></li>
                  <li><a class="nav-link" href="layout-transparent.html">Sortir Data</a></li>
                </ul>
              </li>
              <li class="active"><a class="nav-link" href="<?= base_url('user/survey/show') ?>"><i class="far fa-square"></i> <span>Daftar Survey</span></a></li>
